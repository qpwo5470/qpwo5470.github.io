...
$fi = new FilesystemIterator($parent_dir.'/cards/love/', FilesystemIterator::SKIP_DOTS);
printf("There were %d Files", iterator_count($fi));
$fileName = iterator_count($fi);
    $fp = fopen( $parent_dir.'/cards/love/'.$fileName.'.png', 'wb' );
